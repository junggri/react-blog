...
exports.poolConnction = void 0;
var topic_connection_1 = __importDefault(require("./topic.connection"));
function poolConnction(query, dep) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, _a, result, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, topic_connection_1.default()];
                case 1:
                    conn = _b.sent();
                    if (!(conn !== undefined)) return [3, 5];
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4, conn.execute(query, dep)];
                case 3:
