...
const Meta = ({ data }: any) => {
   ...
   const canonical = `https://www.junggri.com/${data.canonical}`;
   ...
   return (
      <Helmet titleTemplate="%s">
         ...
         <meta property="og:site_name" content="https://www.junggri.com" />
         ...
         <meta property="fb:pages" content="https://www.junggri.com" />
         ...
         <meta name="twitter:site" content="https://www.junggri.com" />
         {/*{canonical ? (*/}
