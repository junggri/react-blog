...
var KindofPosts = function (_a) {
    var onCheck = _a.onCheck, checked = _a.checked;
    var onChange = function (e) {
        onCheck(e.target.value);
    };
    return (react_1.default.createElement(styledComponent_1.KindofPostsComp, null,
        react_1.default.createElement("h1", null, "Kind of Posts"),
        react_1.default.createElement(styledComponent_1.KindofPostItemComp, null,
...
exports.default = react_1.default.memo(KindofPosts);
