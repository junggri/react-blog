...
exports.GET_TOPIC_ERROR = "topic/GET_TOPIC_ERROR";
var getTopic = function () { return ({ type: exports.GET_TOPIC }); };
exports.getTopic = getTopic;
var getTopicSuccess = function (payload) { return ({ type: exports.GET_TOPIC_SUCCESS, payload: payload }); };
...
var onRequestTopicAndTempPostData = function (token) { return function (dispatch, getState) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                e_1 = _a.sent();
                dispatch(exports.getTopicError(e_1));
                return [3 /*break*/, 4];
