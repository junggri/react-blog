...
function BlogEntry() {
    ...
    var _a = useCommon_1.default(), login = _a.login, newRequest = _a.newRequest, setNewRequset = _a.setNewRequset;
    var _b = usePosts_1.default(), AllPosts = _b.AllPosts, getAllPosts = _b.getAllPosts;
    ...
    if (!AllPosts.data)
        return null;
    var data = Object.values(AllPosts.data).flat();
    return (react_1.default.createElement(styled_comp_1.EntryPostsContainerComp, null,
        react_1.default.createElement(useHelmet_1.default, { title: "정그리의 블로그입니다.", keywords: "자바스크립트,nodejs,알고리즘,책,프로그래밍,프론트엔드,백엔드", description: "자바스크립트와 nodejs, 매일 매일 발전해 나가길 원하는 블로그입니다." }),
