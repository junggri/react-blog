...
function ReactHelmet(_a) {
    var title = _a.title, keywords = _a.keywords, description = _a.description, _b = _a.img, img = _b === void 0 ? "http://junggri.com/image/og.jpg" : _b;
    return (react_1.default.createElement(react_helmet_async_1.Helmet, null,
        ...
        react_1.default.createElement("meta", { property: "og:url", content: img, "data-react-helmet": "true" }),
